...
describe('User Repository', () => {
  ...
  const userRepos: IUserRepo[] = [new PrismaUserRepo(prisma)];
  ...
  describe.each(
    ...
    it('can get a user by username', async () => {
      ...
      const fetchedUser = await repo.getByUsername(
